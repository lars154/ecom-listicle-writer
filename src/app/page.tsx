...
import { Sparkles, ArrowRight, Info, LogOut, AlertCircle, ArrowLeftRight, Users, MessageSquare, Layers, ChevronDown, Link, Check, RefreshCw, ArrowLeft } from 'lucide-react';
...
const listicleTypes: { id: string; label: string; mode: ListicleMode; description: string; icon: any }[] = [
  { 
    id: 'first-person', 
    label: 'First-Person Review', 
    mode: 'FirstPersonReview',
    description: 'Written from a personal reviewer perspective with authentic experience. Creates relatability through a genuine testing journey. Headlines like "I Tried [Product]—Here\'s My Honest Review"',
    icon: MessageSquare
  },
  { 
    id: 'problem', 
    label: 'Problem Awareness', 
    mode: 'ProblemAwareness',
    description: 'Highlights relatable problems, symptoms, or mistakes your audience experiences. Great for introducing solutions to pain points. Headlines like "5 Signs You Need..." or "X Mistakes You\'re Making..."',
    icon: AlertCircle
  },
  { 
    id: 'social-proof', 
    label: 'Social Proof / Authority', 
    mode: 'SocialProofAuthority',
    description: 'Focuses on why customers or experts love the product, backed by testimonials, reviews, and credibility. Headlines like "5 Reasons 1,000,000+ [Audience] Made The Switch" or "Why [Expert] Loves [Product]"',
    icon: Users
  },
  { 
    id: 'comparison', 
    label: 'Comparison', 
    mode: 'Comparison',
    description: 'Contrasts old solutions with your new/better approach. Perfect for positioning against competitors or outdated methods. Headlines like "10 Reasons to Ditch [Old] For [New]"',
    icon: ArrowLeftRight
  },
  { 
    id: 'hybrid', 
    ...
    mode: 'Hybrid',
    description: 'Combines multiple listicle approaches for comprehensive coverage. Mix different benefit angles (social proof + features + benefits) within ONE consistent narrative voice.',
    icon: Layers
  },
];
                          ...
                          return (
                            <div key={type.id} className="relative">
                              <div
                                ...
                                className={`relative flex flex-col items-center justify-center p-4 border rounded-xl transition-all cursor-pointer group h-full ${
