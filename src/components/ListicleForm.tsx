...
const LISTICLE_MODES: { value: ListicleMode; label: string }[] = [
  { value: 'ProblemOrSymptomAwareness', label: 'Problem/Symptom Awareness' },
  { value: 'ComparisonOrCategorySwitch', label: 'Comparison / Category Switch' },
  { value: 'SocialProofOrReasonsToBuy', label: 'Social Proof / Reasons to Buy' },
  { value: 'ExpertOrCelebrityEndorsement', label: 'Expert / Celebrity Endorsement' },
  { value: 'ReviewOrEditorialFirstPerson', label: 'Review / First-Person' },
  { value: 'KitOrBundleBreakdown', label: 'Kit / Bundle Breakdown' },
  { value: 'HowToOrRoutine', label: 'How-To / Routine' },
  { value: 'MythBustingOrEducational', label: 'Myth-Busting / Educational' },
