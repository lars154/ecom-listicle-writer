    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-md">
        <div className="text-center space-y-8">
          ...
          {error && (
            <div className={`${error.includes('Check your email') ? 'bg-blue-950/30 border-blue-800' : 'bg-red-950/30 border-red-800'} border rounded-lg p-4`}>
                ...
                <form onSubmit={handleEmailAuth} className="space-y-4">
                  <div className="space-y-2">
                    <input
                      ...
                      required
                      className="w-full bg-slate-900 border border-slate-800 text-white placeholder-slate-500 py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0080FF] focus:border-transparent"
                    />
                    <input
                      type="password"
